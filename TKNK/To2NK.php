        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <select>
                    ...
                    <option value="MPLKTG1">1: Xác định trị giá tính thuế theo phương pháp trị giá giao dịch của hàng
                        hóa giống hệt
                    </option>
                    <option value="MPLKTG2">2: Xác định trị giá tính thuế theo phương pháp giá giao dịch của hàng hóa
                        tương tự</option>
                    ...
                    <option value="MPLKTG7">7: Áp dụng phương pháp trị giá giao dịch trong trường hợp có mối quan hệ đặc
                        biệt nhưng
                        không ảnh hưởng tới trị giá giao dịch</option>
                    <option value="MPLKTG8">8: Áp dụng phương pháp trị giá giao dịch nhưng phân bổ khoản điều chỉnh tính
                        trị giá tính
